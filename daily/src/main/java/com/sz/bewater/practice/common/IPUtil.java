...
///**
// * @Description
// * @Author Feihu Song 11326
// * @Date 2020/11/26 10:09
// */
//public class IPUtil {
//    public final static String ipV4Style1 = "^(((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))\\.){3}((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))(\\/([1-9]|[1-2][0-9]|[3][0-2]))?$";
//    public final static String ipV4Style2 = "^((((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))\\.){3}((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))\\-?){1,2}$";
//    public final static String ipV4Style3 = "^(((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))\\.){3}((\\d{1,2})|(1\\d{2})|(2[0-4]\\d)|(25[0-5]))(\\-(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d))?$";
//    public final static String ipV4Style4 = "(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})";
//
//
//    /**
...
//     *
//     * @return 格式正确返回true，否则为falsew
//     */
//    public static boolean validateIPFormat(String ip) {
//        if (ip.matches(ipV4Style1) || ip.matches(ipV4Style2) || ip.matches(ipV4Style3) || ip.matches(ipV4Style4)) {
//            return true;
//        }
//        return false;
//    }
...
//    }
//
//    public static List<String> getIPv4RangeDisjoint(List<String> sourceRangesIpV6List, List<String> toCheckRangesIpV6List) {
...
//     * @return 拼接后的有序连续的IP地址段
//     */
//    public static List<String> concatIPV4Ranges(List<String> ipRanges) {
...
////        }
//
//        if (strIP != null && Integer.parseInt(strIP.substring(0,strIP.indexOf(".")))==0) {
//            return 0l;
//        }
...
//
//    /**
//     * 根据反掩码计算掩码  0.0.0.15 ==》 255.255.255.240
//     *
//     * @param antiMask 反掩码
//     * @return 掩码
//     */
//    public static String getMaskByAntiMask(String antiMask) {
//        if ("0".equals(antiMask) || "0.0.0.0".equals(antiMask)) {
//            return "255.255.255.255";
//        }
//        String[] masks = antiMask.split("[.]");
//        StringBuilder sb = new StringBuilder();
//        for (String temp : masks) {
//            sb.append(".").append(255 - Integer.parseInt(temp));
//        }
...
//    /**
//     * 例如：
//     * 20.168.20.13 -》020.168.020.013
//     * 1.10.1.10-》001.010.001.010
//     * 200.168.125.120-》200.168.125.120
//     *
//     * @param
//     * @return Description 将单个ip地址转成每个三位的字符
//     */
//    public static String IPV4Format(String ip) {
